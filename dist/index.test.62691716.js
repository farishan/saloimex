...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/jsdom-global/browser.js":[function(require,module,exports) {
/*
...
},{"./lib/chai":"node_modules/chai/lib/chai.js"}],"index.js":[function(require,module,exports) {
var define;
 ...
 */
(function saloimex() {
  var privateKey = 'default_key_data';
  var Saloimex = {
    /**
     * Initialize
     *
    ...
    init: function init(key) {
      if (key) {
        privateKey = "".concat(key.toLowerCase().split(' ').join('_'), "_data");
        return 200;
      }
  ...
  if (typeof define === 'function' && define.amd) {
    /* istanbul ignore next */
    // eslint-disable-next-line no-undef
    define(Saloimex); // eslint-disable-next-line brace-style
  } // CommonJS support
  else if ((typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object' && module !== null && _typeof(module.exports) === 'object') {
...
var Saloimex = require('./index');

it('saloimex should be an object', function () {
  expect(Saloimex).to.be.an('object');
});
it('saloimex.init should be a function', function () {
...
it('saloimex.save should be a function', function () {
  expect(Saloimex.save).to.be.a('function');
});
describe('#save()', function () {
  context('with arguments', function () {
    it('should return 200', function () {
      expect(Saloimex.save({
        myData: 'myData to save'
      })).to.equal(200);
    });
  });
  context('without arguments', function () {
...
it('saloimex.load should be a function', function () {
...
it('saloimex.export should be a function', function () {
...
describe('#export()', function () {
  ...
  context('with arguments', function () {
    it('should return a string', function () {
      expect(Saloimex.export({
        key: 'value'
      })).to.be.a('string');
    });
  });
});
it('saloimex.import should be a function', function () {
...
describe('#import()', function () {
  ...
  context('with arguments', function () {
    it('should return an object', function () {
      var string = Saloimex.export({
        key: 'value'
      });
      expect(Saloimex.import(string)).to.be.an('object');
    });
  });
  context('with empty string arguments', function () {
    it('should return 404', function () {
      expect(Saloimex.import('')).to.equal(404);
    });
  });
});
},{"jsdom-global":"node_modules/jsdom-global/browser.js","chai":"node_modules/chai/index.js","./index":"index.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/index.test.62691716.js.map